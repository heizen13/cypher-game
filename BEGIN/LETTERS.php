...
echo "<br/><img src='CURIOUS.png' alt='letter-C'>";
    ...
    echo "<h1>ZUUP BRUH!?! <br/>ERROR BRUH!!! <br/>TRY AGAIN BRUH!!!<br/> BRUH!?!?!</h1>";
    echo "<pre>Want some hint?
    Try to light me up or just view the source
    ...
    <span style='color:black'>You can drag C on the url.</span></pre>";
  }
  ?>
